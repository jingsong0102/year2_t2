...
@assignment 5
@date 4/5/2024
@brief This file contains the declaration of the ChHashTable class and its related classes and structures.
*/
//---------------------------------------------------------------------------
#ifndef CHHASHTABLEH
#define CHHASHTABLEH
...
class ChHashTable
{
  ...
  private:
    ...
    ChHTHeadNode *table_; // The table
    HTStats *stats_; // Stats
    HTConfig config_; // Config
    ObjectAllocator *allocator_; // Allocator
    /**
     ...
     */
    ChHTNode *new_node(const T& Data);
    /**
